<?php 
session_start(); 
require_once ($_SERVER['DOCUMENT_ROOT'] . '/tulipe/db_connect.php');  // Correction du chemin

$role = $_SESSION['roles'] ?? '1'; // Par défaut on a 'idrole' = 1 si personne n'est connecté
?>
<!DOCTYPE html>
<html lang="fr">
<head>
